        ...
        <div className="m-10 space-y-10 flex flex-col items-center">
          ...
          <div className="text-center max-w-2xl">
            <p className="font-light">
              <strong className="font-medium">Thesis Title:</strong> Detection
              of Avian Influenza Virus H5N1 on Laying Hens (Layer) in Aceh Besar
              by the method of RT-PCR (Reverse Transcriptase Polymerase Chain
              Reaction).
              <br />
              GPA: 3.4 / 4
            </p>
