  ...
  return (
    <Frame title={"About"}>
      <div className="w-full max-w-7xl mx-auto px-8 pt-24 pb-4">
        ...
        <div className="font-teko leading-8 my-8">
