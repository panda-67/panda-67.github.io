      ...
      <div className=" mx-6 md:mx-10 lg:mx-20 my-4 space-y-8 font-sans">
        <div className="flex flex-col md:flex-row gap-2 md:gap-8">
          ...
          <div className="px-4 lg:px-0">
            ...
            <p>
              Melakukan survei kepada masyarakat perkebunan sawit mengenai
              pengaruh kebijakan pemerintah terhadap kesejahteraan masyarakat
              petani sawit dalam rangka Riset Disertasi Peneliti Doktoral ETH
              Zurich bekerjasama dengan Institut Pertanian Bogor di Kabupaten
              Nagan Raya, Kabupaten Aceh Barat Daya, Kabupaten Aceh Selatan dan
        ...
        <div className="flex flex-col md:flex-row-reverse gap-2 md:gap-8">
          ...
          <div className="px-4 lg:px-0 md:text-right">
            ...
            <p>
              Melakukan survei orangutan sumatra di Kawasan Ekosistem Leuser
              dengan posisi sebagai ketua tim survei lapangan. Survei ini
              merupakan survei ulangan dari survei yang telah dilakukan 10 tahun
              sebelumnya.
            </p>
            <p>
              Survei ini diselenggarakan oleh Sumatra Orangutan Conservation
              Program (SOCP) bekerjasama dengan Yayasan Ekosistem Lestari (YEL)
            </p>
          </div>
        </div>
        <div className="flex flex-col md:flex-row gap-2 md:gap-8">
          ...
          <div className="px-4 lg:px-0">
            ...
            <p>
              Sebagai setting grafis, saya bertugas mempersiapkan file-file
              desain untuk dicetak. Selain itu, saya juga melayout desain dan
              membuat desain seperti, banner, label, spanduk, logo, buku, pin,
              dll.
            </p>
          </div>
        </div>
        <div className="flex flex-col md:flex-row-reverse gap-2 md:gap-8">
          ...
          <div className="px-4 lg:px-0 md:text-right">
            ...
            <p>
              Melakukan pemetaan pada kawasan Lembah Seulawah Kabupaten Aceh
              Besar.
            </p>
          </div>
        </div>
