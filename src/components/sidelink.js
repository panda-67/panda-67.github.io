...
const active = (
  'inline-flex items-center px-1 pt-1 pb-2 border-b-2 text-2xl leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition  duration-150 ease-in-out'
)
const inactive = (
