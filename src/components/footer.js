...
const Footer = ({ socials, siteTitle }) => {
  return (
    <div>
      <div className="mt-4 py-8 px-6 lg:px-16 bg-zinc-400 md:grid grid-flow-col font-teko text-sm">
        <div>
          <h3>Social Links</h3>
        ...
        <div>
          ...
          <div className='m-2 px-2 space-y-2'>
            ...
            <Link to='https://wa.me/6282227701884?text=Hello' target="_blank" className='flex gap-2'>
